...
use super::super::gates::subtraction_u32::U32SubtractionGate;
use super::super::witness::GeneratedValuesU32;
...
pub trait CircuitBuilderU32<F: RichField + Extendable<D>, const D: usize> {
    ...
    fn connect_u64(&mut self, x: [U32Target; 2], y: [U32Target; 2]);
    ...
    fn mul_const_add_u32(&mut self, x: u32, y: U32Target, z: U32Target) -> (U32Target, U32Target);
    ...
    for CircuitBuilder<F, D>
{
    ...
    fn mul_const_add_u32(
        &mut self,
        const0: u32,
        y: U32Target,
        z: U32Target,
    ) -> (U32Target, U32Target) {
        let const0 = self.constant_u32(const0);
        self.mul_add_u32(const0, y, z)
    }
}
    ...
    for SplitToU32Generator<F, D>
{
        ...
        Self: Sized,
    {
        ...
        let low = U32Target(src.read_target()?);
        let high = U32Target(src.read_target()?);
        Ok(Self {
            x,
            low,
            high,
